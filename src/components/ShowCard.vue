  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          class="show-card__poster-wrapper relative h-[330px] w-full overflow-hidden bg-[#0d111a]"
        >
          <img
            v-if="posterUrl"
            :src="posterUrl"
        ...
        >
          ...
          <div class="show-card__rating-tagline-row flex items-center gap-[1rem]">
            ...
            >
              ...
              <span
                class="show-card__imdb-score text-[1.15rem] leading-none font-bold text-white"
